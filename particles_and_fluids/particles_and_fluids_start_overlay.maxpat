...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 1080.0, 1290.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 945.0, 795.0, 164.0, 234.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 705.0, 1020.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 705.0, 990.0, 100.0, 20.0 ],
					"text" : "t b b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 705.0, 960.0, 100.0, 20.0 ],
					"text" : "r renderbang_"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 953.0, 1330.0, 80.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 773.0, 1230.0, 132.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 866.0, 1284.0, 64.0, 17.0 ],
					"text" : "gaussian blur"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 765.0, 1130.0, 201.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 788.0, 1164.0, 42.0, 17.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 788.0, 1184.0, 88.0, 15.0 ],
					"text" : "param amount $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 978.0, 1205.0, 43.0, 15.0 ],
					"text" : "$1 400"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 997.0, 1120.0, 50.0, 17.0 ],
					"text" : "qlim 500"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 655.0, 1066.0, 48.0, 17.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 705.0, 1065.0, 47.0, 47.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 705.0, 1158.0, 27.0, 17.0 ],
					"text" : "+ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 705.0, 1186.0, 38.0, 17.0 ],
					"text" : "gate 2"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 733.0, 1211.0, 171.0, 17.0 ],
					"text" : "jit.gl.slab rendertest @file co.dodge.jxs"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 978.0, 1145.0, 29.0, 17.0 ],
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 978.0, 1186.0, 103.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 975.0, 1170.0, 64.0, 17.0 ],
					"text" : "random 1000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 977.0, 1246.0, 81.0, 15.0 ],
					"text" : "param width $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 733.0, 1265.0, 197.0, 17.0 ],
					"text" : "jit.gl.slab rendertest @file cf.gaussian.2p.jxs"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 735.0, 1140.0, 233.0, 27.0 ],
					"text" : "jit.gl.texture rendertest @name warpys @dim 1920 1080"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 753.0, 1070.0, 57.0, 37.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 640.0, 1071.0, 16.0, 15.0 ],
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 315.0, 630.0, 100.0, 20.0 ],
					"text" : "s fluids_out"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 480.0, 555.0, 345.0, 255.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 705.0, 195.0, 60.0, 135.0 ],
					"size" : 227.0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 555.0, 600.0, 166.0, 194.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 450.0, 360.0, 90.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 390.0, 55.0, 90.0, 20.0 ],
					"text" : "context name"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 360.0, 360.0, 60.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 390.0, 35.0, 60.0, 20.0 ],
					"text" : "on/off"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 360.0, 330.0, 60.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 585.0, 465.0, 60.0, 18.0 ],
					"text" : "name $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 450.0, 465.0, 75.0, 18.0 ],
					"text" : "drawto $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 450.0, 420.0, 100.0, 19.0 ],
					"text" : "route text"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 450.0, 390.0, 105.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 480.0, 55.0, 80.0, 20.0 ],
					"text" : "testz"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1185.0, 240.0, 150.0, 60.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 990.0, 225.0, 150.0, 88.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 360.0, 465.0, 67.0, 20.0 ],
					"text" : "t b erase"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 360.0, 420.0, 58.0, 20.0 ],
					"text" : "metro 16"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 360.0, 390.0, 20.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 480.0, 35.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 675.0, 465.0, 165.0, 20.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 459.5, 451.5, 594.5, 451.5 ],
					"source" : [ "obj-23", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 797.5, 1206.0, 742.5, 1206.0 ],
					"source" : [ "obj-38", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 305.5, 90.0, 39.5, 90.0 ],
					"source" : [ "obj-5", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 714.5, 1116.0, 987.5, 1116.0 ],
					"source" : [ "obj-59", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 986.5, 1261.0, 742.5, 1261.0 ],
					"source" : [ "obj-72", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 742.5, 1333.0, 725.0, 1333.0, 725.0, 1206.0, 894.5, 1206.0 ],
					"source" : [ "obj-75", 0 ]
				}
...
, 			{
				"name" : "jmod.tml.fluids%.maxpat",
				"bootpath" : "/Users/aa/Desktop/ilya_active/particles_and_fluids",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
