...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 585.0, 1290.0, 572.0, 31.0 ],
					"text" : "jcom.parameter velocityFade @type decimal @range/clipmode both @range/bounds 0. 1. @repetitions/allow 0 @ramp/drive none @description \"Velocity fade.\"",
					"varname" : "viscosity[8]"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "jcom.parameter densityFade @type decimal @range/clipmode none @range/bounds 0. 1. @repetitions/allow 0 @ramp/drive none @description \"Density fade.\"",
					"varname" : "viscosity[9]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 585.0, 1065.0, 597.0, 31.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 705.0, 870.0, 594.0, 31.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 585.0, 600.0, 539.0, 31.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 585.0, 555.0, 551.0, 31.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 585.0, 510.0, 574.0, 31.0 ],
